...
DIR_GRASSROOTS_JANSSON_LIB = $$DIR_GRASSROOTS_JANSSON/lib/debug
...
DIR_GRASSROOTS_CURL = $$DIR_GRASSROOTS_EXTRAS/curl
DIR_GRASSROOTS_CURL_INC = $$DIR_GRASSROOTS_CURL/include
DIR_GRASSROOTS_CURL_LIB = $$DIR_GRASSROOTS_CURL/lib/debug
GRASSROOTS_CURL_LIB_NAME = curl


DIR_IRODS_LIBS = $$DIR_IRODS_HOME/usr/lib


DEFINES += "WINDOWS" "_DEBUG" "SHARED_LIBRARY" "_ALLOW_KEYWORD_MACROS " "_CRTDBG_MAP_ALLOC=0" # "QT_NO_DEBUG_OUTPUT"

INCLUDEPATH += \
    $$DIR_GRASSROOTS_QT_SRC/include \
    $$DIR_GRASSROOTS_CURL_INC \
